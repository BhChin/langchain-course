...
SAMPLE_DOCS = [
    ...
    # Document(
    #     page_content="Vector Vector Vector vector ",
    #     metadata={"source": "vector_giant", "topic": "story"},
    # ),
]
...
def chroma_basics():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        results = vectorstore.similarity_search(query, k=3) # k is how many related documents you want to return
...
def similarity_search_with_scores():
    ...
    # or
    # simiarlity = 1 - (distance / max distance)
...
def metadata_filtering():
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        filtered_results = vectorstore.similarity_search(
            query, k=5, filter=filter_criteria # new parameter: filter
        )
