...
def demo_basic_rag():
    ...
    #rag chain
    rag_chain = (
        {"context": retriever | format_docs, "question": RunnablePassthrough()} #RunnablePassThrough makes sure it passes through unchanged
        | prompt
        | llm
        | StrOutputParser() # output is turned into a string
    )
